...
// Nyertél kiírás
void console::print_megnyerted(int nyero_egyenleg){
    cout << endl << "===============================================================" << endl;
    cout << R"(
  _   _                         _            _     _   _   _
 | \ | |  _   _    ___   _ __  | |_    ___  | |   | | | | | |
 ...
 |_| \_|  \__, |  \___| |_|     \__|  \___| |_|   (_) (_) (_)
    ...
    cout << endl << " Gratulalunk, elerted a nyereshez szukseges osszeget: " << nyero_egyenleg << " Ft" << endl;
    cout << " Most vissza mesz a fomenube." << endl;
}
